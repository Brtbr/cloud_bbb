...
class RoomService {
	...
	public function create(string $name, string $welcome, int $maxParticipants, bool $record, string $access, string $roomLife, string $userId): \OCP\AppFramework\Db\Entity {
		$room = new Room();
